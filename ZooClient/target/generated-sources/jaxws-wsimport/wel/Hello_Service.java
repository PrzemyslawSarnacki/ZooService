 ...
 * 
 */
@WebServiceClient(name = "Hello", targetNamespace = "http://wel/", wsdlLocation = "http://localhost:8080/Exampel/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLO_QNAME = new QName("http://wel/", "Hello");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Exampel/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wel/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wel/", "HelloPort"), Hello.class, features);
    }
